...
export
    ...
    slab_cache_style,
    slab_cache_key,
    certified_residual_capability,
    scalar_logscale_gaussian_line_segment,
    log_boundary_density_zero,
    boundary_logweights!,
    aggregate_lograte,
    sample_unstick_label,
    SummedRateClock,
    LinearGaussianAggregateClock,
    ExponentialSumAggregateClock,
    ChebyshevResidualAggregateClock,
    FourierResidualAggregateClock,
    default_aggregate_unstick_clock,
    reset_thinning_diagnostics!,
    thinning_diagnostics,
    unstick_rate_constant,
